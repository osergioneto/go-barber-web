      ...
      try {
        ...
        const schema = Yup.object().shape({
          ...
          password: Yup.string().when('old_password', {
            is: (val) => !!val.length,
            than: Yup.string().required('Campo obrigatório'),
        ...
        addToast({
          ...
          description:
            'Suas informçãoes do perfil foram atualizadas com sucesso',
        });
      } catch (error) {
        ...
        addToast({
          ...
          description:
            'Houve algum ao atualizar o seu perfil. Tente novamente.',
        });
      }
    },
    [addToast, history],
